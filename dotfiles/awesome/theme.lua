...
-- Uptime
local uptime = awful.widget.watch('uptime --pretty', 1, function(widget, stdout)
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
	    ...
	    mem.widget,
            ...
            --wibox.container.background(cpuicon, theme.arrow1),
            --wibox.container.background(cpu.widget, theme.arrow1),
	    cpuicon,
	    cpu.widget,
            --arrl_dl,
	    --wibox.container.background(cpu_temp_icon, theme.arrow2),
            --wibox.container.background(cpu_temp, theme.arrow2),
	    cpu_temp_icon,
	    cpu_temp,
	    ...
	    --baticon,
            --bat.widget,
            --arrl_ld,
            --wibox.container.background(neticon, theme.arrow1),
            --wibox.container.background(net.widget, theme.arrow1),
	    neticon,
	    net.widget,
        spr,
        uptime,
