...
function install_basic() {
    echo 'htop autojump dbus dbus-openrc dbus-python dbus-glib fzf git grub gtk2 gtk3 neofetch neovim neovim-symlinks perl python ranger rmtrash syntax-highlighting tldr trash-cli ttf-dejavu ttf-hack util-linux wget lsd nvim-packer-git python-pip galaxy/fish opendoas-sudo'
}
