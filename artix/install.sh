...
basestrap -C $ARTIXD_DIR/../config-files/pacman.conf.install $INSTALL_DIR base openrc elogind-openrc linux-firmware linux-zen system/mkinitcpio iptables-nft archlinux-keyring artix-keyring artix-mirrorlist
