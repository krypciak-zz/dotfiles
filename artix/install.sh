...
export LANG
basestrap -C $ARTIXD_DIR/../config-files/pacman.conf.install base $INSTALL_DIR openrc elogind-openrc artix-keyring artix-mirrorlist pacman autoconf automake bison fakeroot flex gcc groff libtool m4 make patch pkgconf texinfo which iptables-nft
